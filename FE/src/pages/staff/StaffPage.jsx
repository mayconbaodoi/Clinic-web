            ...
            <header className="manager-header-redesign">
                <div className="manager-header-flex">
                    ...
                    <div className="manager-header-center">
                        <span className="manager-title">Staff Dashboard</span>
                    </div>
                ...
                <nav className="manager-nav-redesign">
                    <Link to="/staff/sample" className="manager-btn">Quản lý mẫu xét nghiệm</Link>
                    <Link to="/staff/staff-chat" className="manager-btn">Chat với khách hàng</Link>
                </nav>
            </header>
