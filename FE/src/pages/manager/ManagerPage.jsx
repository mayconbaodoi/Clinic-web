        ...
        <div className="manager-dashboard">
            <header className="manager-header-redesign">
                ...
                <nav className="manager-nav-redesign">
                    <Link to="/manager/staff" className="manager-btn">
                        Quản lý Nhân Viên
                    </Link>
                    <button className="manager-btn">Monitor Testing Process</button>
                    <Link to="/manager/service" className="manager-btn">
                        Quản lý Dịch vụ & Giá
                    </Link>
                    <button className="manager-btn">Dashboard & Reporting</button>
                </nav>
            </header>
