...
import "../../skin_web/manager/ManagerPage.css";
      ...
      <header className="manager-header-redesign">
        <div className="manager-header-flex">
          <div className="manager-header-left">
            <Link to="/" className="manager-home-btn" style={{marginRight: 16, fontWeight: 700, color: '#2176bd', textDecoration: 'none', fontSize: '1.1rem'}}>Trang chủ</Link>
            <Link to="/">
              <img
        ...
        <nav className="manager-nav-redesign">
          <Link to="/manager/staff" className="manager-btn"> Quản lý Nhân Viên</Link>

          <Link to="/manager/booking" className="manager-btn"> Quản lý Quá Trình Đặt Dịch Vụ </Link>

          <Link to="/manager/service" className="manager-btn"> Quản lý Dịch vụ & Giá </Link>
