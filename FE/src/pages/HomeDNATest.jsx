...
const HomeDNAService = () => {
    ...
    return (
        <div className="home-dna-service-container">
            <h1 className="service-title">Xét Nghiệm ADN Khi Nhân Viên Đến Nhà - An Toàn, Tiện Lợi, Chính Xác </h1>
            ...
            <div className="cta-section">
                <button className="more-btn" onClick={() => navigate('/form')}>ĐĂNG KÍ NGAY</button>
            </div>
        </div>
    );
};
